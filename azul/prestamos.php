...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO prestamo (efectivo, fecha, num_sem, cob_sem, trabajadores_idtrabajadores,adeudo) VALUES (%s, %s, %s, %s, %s,%s)",
                       $_POST['efectivo'],
                       "'".$f."'",
  ...
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
   //  $efectivo = $efectivo - $resta;
    ...
    $insertSQL = sprintf("INSERT INTO cortecaja (fecha_corte,concepto,cantidad, entrada,csucursal) VALUES (%s, %s,%s,0,%s)",
