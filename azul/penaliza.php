...
mysql_select_db($database_conexion, $conexion);
$query_Recordset3 = "SELECT * FROM trabajadores,penaliza WHERE trabajadores_idtrabajadores = idtrabajadores AND sucursal='".$sucursal."' AND fecha_p BETWEEN '".$f."' AND '".$f1."'";
