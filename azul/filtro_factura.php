...
$query_prim = "SELECT * FROM combustible,trabajadores,vehiculos WHERE combustible.sucursal = '".$suc."' AND trabajadores_idtrabajadores = idtrabajadores  AND vehiculos_numeco = numeco ".$fils."ORDER BY fecha DESC";
...
mysql_select_db($database_conexion, $conexion);
$query_segu = "SELECT SUM(importe),SUM(litcarg) FROM combustible,trabajadores,vehiculos WHERE  combustible.sucursal = '".$suc."' AND trabajadores_idtrabajadores = idtrabajadores  AND vehiculos_numeco = numeco ".$fils."ORDER BY fecha DESC";
