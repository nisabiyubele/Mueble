...
<a href="./nom_v.php?sucursal=<?php echo $sucursal;?>" target="_new" >Nómina Imprimible</a>
...
//Poner el codigo cortado 01-11-2017
...
//."->".$ex_ded."+".$otr."+".$mueble."+".$fuga."+".$pena."+".$falta."+".$presta."+".$moto."+".$seguro."+".$vale."+".
    ...
    $Recordset10 = mysql_query($query_Recordset10, $conexion) or die(mysql_error()); 
    $Recordset11 = mysql_query($query_Recordset11, $conexion) or die(mysql_error()); 
	$losid[]= $row_Recordset1['idtrabajadores']; $ex_ded=0;$seguro =0; $moto=0; $presta =0; $vale=0;} while ($row_Recordset1 = mysql_fetch_assoc($Recordset1)); ?>
...
<?php /*do{
 ...
 <input type="password" name="contra" id="contra" onkeyup="validar()" />
     ...
     <td><input type="submit" value="Guardar Nómina" disabled="disabled" id= "bton" /></td>
