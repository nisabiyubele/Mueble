...
$query_Recordset1 = "SELECT * ,SUM(tarjetas), SUM(efectivo) FROM vale,trabajadores WHERE fecha BETWEEN '".$f."' AND '".$f1."' AND idtrabajadores = trabajadores_idtrabajadores AND sucursal ='".$sucursal."' GROUP BY nombre ORDER BY ruta";
...
<a href="./nom_c.php?sucursal=<?php echo $sucursal;?>" target="_new" >Nómina Imprimible</a>
...
<table border="1" align="center" rules="all">
    ...
    <tr align="center" valign="middle">
     ...
     <td>
        <input name="comision[]" type="text" id="comision<?php echo $i;?>" tabindex=2 value=9 onkeyup="porc(this.value,'<?php echo "cobro".$i?>','<?php echo "sueldo".$i; ?>',<?php echo $i;?>)" value="0" size="3" align="middle"/>
     </td>
...
//************************************************************************************************** ?> <input name="seguro[]" type="hidden" id="seguro" value="<?php echo $seguro;?>" size="3" /> 
     ...
     if($row_Recordset1['idtrabajadores'] == $row_Recordset3['trabajadores_idtrabajadores']){
                     if(! in_array($row_Recordset3['trabajadores_idtrabajadores'], $losid)){
                                $d_presta = $row_Recordset3['adeudo'] + $d_presta;
     ...
     if($row_Recordset1['idtrabajadores'] == $row_Recordset3['trabajadores_idtrabajadores']){
                        if(! in_array($row_Recordset3['trabajadores_idtrabajadores'], $losid)){
                     $presta=$row_Recordset3['cob_sem']+$presta;
...
//**********************************************************************************************---------------------
     ...
     if($row_Recordset1['idtrabajadores'] == $row_Recordset4['trabajadores_idtrabajadores']){
                     if(! in_array($row_Recordset4['trabajadores_idtrabajadores'], $losid)){
                        $moto= $row_Recordset4['cob_sem'] + $moto;
...
<input type="submit" value="Guardar Nómina" disabled="disabled" id= "bton"/></td>
