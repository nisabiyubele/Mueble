...
//*******************************************************************************************************************************************
    ...
    $insertGoTo = "venta.php?sucursal=".$sucursal;
    if (isset($_SERVER['QUERY_STRING'])) {
        ...
        <script type="text/javascript">
            $(function(){
                $('#combo1').autocomplete({
                 ...
                 select : function(event, ui,sucursal){
                     /*$('#resultados').slideUp('slow', function(){
                            $('#resultados').html(
                                '<h2>Detalles de usuario</h2>' +
                                '<br/>' +
...
<input name="municipio" id="muni" list="munic" required autocomplete="off" 
...
?>
         <option value="<?php
                               echo $row_Recordset3['idarticulos'].'-'.$row_Recordset3['articulo'];
                        ?>"
          >              
                         <?php echo $row_Recordset3['idarticulos'].'-'.$row_Recordset3['articulo'];
                        ?> 
                         ="abrirVentana()">
...
//function pasarOpciones() { 
var combo1 = document.getElementById('muni').value;
//var combo1 = document.getElementById('combo1').value;
var combo2 = document.getElementById('combo2').options;
...
?>
    ...
    <tr valign="baseline">
     ...
     <td><input type="submit" value="Guardar Venta" disabled="disabled" id="bton"/></td>
    </tr>
    </table>
