...
while ( $row = mysql_fetch_assoc( $result ) ) {
  ...
  if($row['sucursal']=="Apatzingan"){
	  echo '  "apatzingan": ' . $row['cantidad'] . '' . "\n";
	  echo '  "uruapan": ' . 0 . '' . "\n";
	  echo '  "tacambaro": ' . 0 . '' . "\n";
	 }
  if($row['sucursal']=="Uruapan"){
	  echo '  "apatzingan": ' . 0 . '' . "\n";
	  echo '  "uruapan": ' . $row['cantidad'] . '' . "\n";
	  echo '  "tacambaro": ' . 0 . '' . "\n";
  }
  if($row['sucursal']=="Tacambaro"){
	  echo '  "apatzingan": ' . 0 . '' . "\n";
	  echo '  "uruapan": ' . 0 . '' . "\n";
	  echo '  "tacambaro": ' . $row['cantidad'] . '' . "\n";
	  }
