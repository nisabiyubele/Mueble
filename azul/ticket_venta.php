...
<div align="center" style=" font-size:14px" >
  ...
  <p align="center" style=" font-size:14px; line-height: 100%;" > <strong>Fecha de Abono:</strong> <?php echo $fecha;?></p>
  ...
  <p align="center" style=" font-size:14px" ><strong>Abono de : $</strong><?php echo $cantidad;?></p>
  <p align="center" style=" font-size:14px" ><strong>Saldo Actual : $</strong><?php echo $saldo;?></p>
  
  
  
  <p align="center" style=" font-size:14px" ><strong>¡Gracias por su Compra!</strong></p>
