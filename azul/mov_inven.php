            ...
            $(function(){
                $('#art').autocomplete({
                   ...
                   select : function(event, ui){
					...
					document.getElementById('articulos').value = ui.item.id;
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
    ...
    <tr valign="baseline">
     ...
     <td><input name="fecha" type="text" value="<?php echo $fecha;?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
     ...
     <input type="text" name="art" id="art" />
      <input type="text" name="articulos" id="articulos" />
