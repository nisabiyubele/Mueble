...
mysql_select_db($database_conexion, $conexion);
$query_Recordset2 = "SELECT * FROM trabajadores WHERE sucursal = '".$sucursal."' OR sucursal= ''";
...
AND combustible.sucursal = '".$sucursal."' ORDER BY idcombustible DESC LIMIT 0,15";
...
<option>Sucursales</option>
    ...
    <tr valign="baseline">
     <td nowrap="nowrap" align="right">Vehiculo(Núm Economico):</td>
     <td>
    ...
    <tr valign="baseline">
     <td nowrap="nowrap" align="right">Kilometraje Inicial:</td>
...
<input name="kini" type="text" id="kini" readonly="readonly" />
    ...
    <tr valign="baseline">
     <td nowrap="nowrap" align="right">Kilometraje Final:</td>
    ...
    <tr valign="baseline">
     <td nowrap="nowrap" align="right">Kilometros Recorridos:</td>
    ...
    <tr valign="baseline">
     <td nowrap="nowrap" align="right">Lts Cargados:</td>
    ...
    <tr valign="baseline">
     <td nowrap="nowrap" align="right">Precio por Litro:</td>
    ...
    <tr valign="baseline">
     ...
     <input name="sucursal" type="text" id="sucursal" value="<?php echo $sucursal; ?>" size="50" readonly="readonly" /></td>
    </tr>

   <tr valign="baseline">

      <td nowrap="nowrap" align="right">Núm Factura</td>
