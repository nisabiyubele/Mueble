...
$query_Recordset1 = "SELECT concepto,fecha_corte,SUM(cantidad) FROM cortecaja WHERE fecha_corte BETWEEN '".$f."' AND '".$f1."' AND entrada = '1'  GROUP BY concepto";
$Recordset1 = mysql_query($query_Recordset1, $conexion) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
$totalRows_Recordset1 = mysql_num_rows($Recordset1);

mysql_select_db($database_conexion, $conexion);
$query_Recordset2 = "SELECT concepto,fecha_corte,SUM(cantidad) FROM cortecaja WHERE fecha_corte BETWEEN '".$f."' AND '".$f1."' AND entrada = '0' GROUP BY concepto" ;
...
mysql_select_db($database_conexion, $conexion);
$query_Recordset6 = "SELECT * FROM cortecaja WHERE fecha_corte BETWEEN '".$f."' AND '".$f1."' AND entrada = '1'";
$Recordset6 = mysql_query($query_Recordset6, $conexion) or die(mysql_error());
$row_Recordset6 = mysql_fetch_assoc($Recordset6);
$totalRows_Recordset6 = mysql_num_rows($Recordset6);

mysql_select_db($database_conexion, $conexion);
$query_Recordset7 = "SELECT * FROM cortecaja WHERE fecha_corte BETWEEN '".$f."' AND '".$f1."' AND entrada = '0'";
