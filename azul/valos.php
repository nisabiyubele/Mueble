...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO cortecaja (fecha_corte, concepto, cantidad, entrada, descripcion, comprobante) VALUES (%s, %s, %s, 0, %s, %s)",
                       GetSQLValueString($_POST['fechava'], "date"),
                       $cc,
                       GetSQLValueString($_POST['cantidad'], "double"),
                       //0,
...
mysql_select_db($database_conexion, $conexion);
$query_Recordset3 = "SELECT * FROM valos,trabajadores WHERE trabajadores_idtrabajadores = idtrabajadores";
