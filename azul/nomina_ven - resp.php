...
list($clav24, $valor24) = each($_POST['smueble']);
list($clav25, $valor25) = each($_POST['sfuga']);
list($clav26, $valor26) = each($_POST['sfalta']);
...
mysql_select_db($database_conexion, $conexion);
$query_Recordset1 = "SELECT * ,SUM(cantidad), COUNT(*),SUM(enganche) FROM venta,trabajadores WHERE fecha  BETWEEN '".$f."' AND '".$f1."' AND idtrabajadores = trabajadores_idtrabajadores AND cancelada is NULL GROUP BY idtrabajadores";
...
mysql_select_db($database_conexion, $conexion);
$query_Recordset6 = "SELECT * ,SUM(tarjetas), SUM(efectivo) FROM vale,trabajadores WHERE fecha  BETWEEN '".$f."' AND '".$f1."' AND idtrabajadores = trabajadores_idtrabajadores GROUP BY ruta";
...
<table border="1" align="center" rules="all">
  <tr>
    ...
    <td colspan="18" align="center" valign="middle"><strong>Deducciones</strong></td>
  ...
  ?>
    <tr align="center" valign="middle">
      ...
      <td><input name="sueldo[]" type="text" id="sueldo<?php echo $i?>" tabindex=0 value="<?php $sue = $row_Recordset1['SUM(cantidad)'] * 0.05; echo $sue;?>" size="5" readonly="readonly"/></td>
...
//**************************************************************************************************				?>
      ...
      <td><?php $faltas=0; do{
				...
				echo $faltas;
//**************************************************************************************************				?>
      <input type="hidden" name="sfalta[]" value="<?php echo $faltas; ?>" size="5" />
...
//**************************************************************************************************				?>
 ...
 <?php $fugas=0; do{
				 ...
				 echo $fugas;
//**************************************************************************************************				?>
      <input type="hidden" name="sfuga[]" value="<?php echo $fugas; ?>" size="5" />
...
//**************************************************************************************************				?>
      ...
      <td><?php $muebles=0; do{
				...
				echo $muebles;
//**************************************************************************************************				?>
      <input type="hidden" name="smueble[]" value="<?php echo $muebles; ?>" size="5" />
      <?php $Recordset10 = mysql_query($query_Recordset10, $conexion) or die(mysql_error());?></td>
...
//**************************************************************************************************				?>
 ...
 <tr align="center" valign="middle">
      <td colspan="14">&nbsp;</td>
      <td colspan="12"><strong>Total a Pagar</strong></td>
      <td>
