...
$query_Recordset1 = "SELECT concepto,fecha_corte,SUM(cantidad) FROM cortecaja WHERE fecha_corte BETWEEN '".$f."' AND '".$f1."' AND entrada = '1' AND csucursal = '".$sucursal."'  GROUP BY concepto";
...
mysql_select_db($database_conexion, $conexion);
$query_Recordset2 = "SELECT concepto,fecha_corte,SUM(cantidad) FROM cortecaja WHERE fecha_corte BETWEEN '".$f."' AND '".$f1."' AND entrada = '0' AND csucursal = '".$sucursal."' GROUP BY concepto" ;
...
mysql_select_db($database_conexion, $conexion);
$query_Recordset3 = "SELECT SUM(total)FROM nomina,trabajadores WHERE trabajadores_idtrabajadores = idtrabajadores AND sucursal = '".$sucursal."' AND  fecha_na BETWEEN '".$f."' AND '".$f1."'";
...
mysql_select_db($database_conexion, $conexion);
$query_Recordset4 = "SELECT SUM(total) FROM nomina_cob,trabajadores WHERE trabajadores_idtrabajadores = idtrabajadores AND sucursal = '".$sucursal."' AND fecha_na BETWEEN '".$f."' AND '".$f1."'";
...
mysql_select_db($database_conexion, $conexion);
$query_Recordset5 = "SELECT SUM(total) FROM nomina_vent,trabajadores WHERE trabajadores_idtrabajadores = idtrabajadores AND sucursal = '".$sucursal."' AND fecha_na BETWEEN '".$f."' AND '".$f1."'";
...
mysql_select_db($database_conexion, $conexion);
$query_Recordset6 = "SELECT * FROM cortecaja WHERE fecha_corte BETWEEN '".$f."' AND '".$f1."' AND entrada = '1' AND csucursal = '".$sucursal."'";
...
mysql_select_db($database_conexion, $conexion);
$query_Recordset7 = "SELECT * FROM cortecaja WHERE fecha_corte BETWEEN '".$f."' AND '".$f1."' AND entrada = '0' AND csucursal = '".$sucursal."'";
...
<script type="text/javascript">
  ...
  $(function() {
    $( "#fec" ).datepicker({dateFormat: 'yy-mm-dd 00:00:00'});
	$( "#fec2" ).datepicker({dateFormat: 'yy-mm-dd 23:59:59'});
...
<body>
	...
	<form action="corte_sem_fecha.php" method="post">
    ...
    <input name="fec" type="text" id="fec" />
    <input name="fec2" type="text" id="fec2" />
    <input name="filtar" type="submit" value="Filtrar" />
    </form>
...
<?php echo "Del ".$fechas[2]." de ".$meses[$fechas[1]-1]." de ".$fechas[0]." al ".($fechas2[2]-1)." de ".$meses[$fechas2[1]-1]." de ".$fechas2[0];?> </p></td>
    ...
    <?php $losid[]=0;$enga = 0; $can =0; 
     ...
     do {//
         ...
         $aux1=$row_Recordset1['SUM(cantidad)']; 
                $enga= $enga + $aux1;
                //echo "(".$aux1.")";
                echo "<li class='letra'> $ ".$row_Recordset1['SUM(cantidad)']."⇨".$row_Recordset1['concepto']."</li>";
    ...
    <?php $ruta = 0; 
     do {
         $qu1 =strpos($row_Recordset1['concepto'],'Ruta');
            //
            if($qu1!==FALSE){
         $aux2=$row_Recordset1['SUM(cantidad)']; 
                $ruta= $ruta + $aux2;
                //echo "(".$aux2.")";
                echo "<li class='letra'> $ ".$row_Recordset1['SUM(cantidad)']."⇨".$row_Recordset1['concepto']."</li>";
                }
    ...
    do {
         $qu =strpos($row_Recordset6['concepto'],'Enganche');
         $qu1 =strpos($row_Recordset6['concepto'],'Ruta');
            //
            if(($qu===FALSE)&&($qu1===FALSE)){ 
                /*$aux6=$row_Recordset1['cantidad']; 
                $gral= $gral + $aux6; */
                $aux3=$row_Recordset6['cantidad']; 
                $otro= $otro + $aux3;
                ?>
    <tr>
     <td><?php echo $row_Recordset6['fecha_corte']; ?></td>
     <td><?php echo $row_Recordset6['concepto']; ?></td>
     <td><?php echo $row_Recordset6['cantidad']; 
     $au=$row_Recordset6['cantidad'];
     $entrada = $entrada + $au;?></td>
     <td><?php echo $row_Recordset6['comprobante']; ?></td>
     <td><?php echo $row_Recordset6['descripcion']; ?></td>
    </tr>
    <?php 
            }
    ...
    <td><li>Vales: 
     ...
     do {
         $qu3 =strpos($row_Recordset2['concepto'],'Vale');
            //
            if($qu3!==FALSE){
         $aux4=$row_Recordset2['SUM(cantidad)']; 
                $vale= $vale + $aux4;
                //echo "(".$aux2.")";
                echo "<li class='letra'> $ ".$row_Recordset2['SUM(cantidad)']."⇨".$row_Recordset2['concepto']."</li>";
                }
    ...
    $deposito = 0; 
     do {
         $qu4 =strpos($row_Recordset7['concepto'],'Deposito');
            //
            if($qu4!==FALSE){
         $aux5=$row_Recordset7['cantidad']; 
                $deposito= $deposito + $aux5;
         ?>
    <tr>
     <td><?php echo $row_Recordset7['fecha_corte']; ?></td>
     <td><?php echo $row_Recordset7['concepto']; ?></td>
     <td><?php echo $row_Recordset7['cantidad']; 
     $au=$row_Recordset7['cantidad'];
     $entrada = $entrada + $au;?></td>
     <td><?php echo $row_Recordset7['comprobante']; ?></td>
     <td><?php echo $row_Recordset7['descripcion']; ?></td>
    </tr>
    <?php 
            }
    ...
    <?php $entrada =0;
    do {
         $qu4 =strpos($row_Recordset7['concepto'],'Vale');
         $qu5 =strpos($row_Recordset7['concepto'],'Deposito');
            //
            if(($qu4===FALSE)&&($qu5===FALSE)){ $aux6=$row_Recordset7['cantidad']; 
                $gral= $gral + $aux6; ?>
    <tr>
     <td><?php echo $row_Recordset7['fecha_corte']; ?></td>
     <td><?php echo $row_Recordset7['concepto']; ?></td>
