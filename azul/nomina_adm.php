...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    $insertSQL = sprintf("INSERT INTO nomina (fecha_na, nombre, sueldo, extra, total_ing, seguro, vales, prestamo, des_pres, moto, desc_moto, ot_conc, ot_impo, total_egr, total, trabajadores_idtrabajadores,adeudo) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,%s)",
                     "'".$fechar."'",
                     "'".$co."'",
                     $valor3,
                     $valor1,
...
<a href="./nom_a.php?sucursal=<?php echo $sucursal;?>" target="_new" >Nómina Imprimible</a>
...
//************************************************************************************************** ?>
     ...
     if($row_Recordset1['idtrabajadores'] == $row_Recordset3['trabajadores_idtrabajadores']){
                        ...
                        $xpresta= $row_Recordset3['adeudo']+$xpresta;
...
//&&($row_Recordset8['concepto']=="Mueble")
...
?> 
     ...
     echo $tegres;?>
        ...
        echo $subto; 
        $total = number_format($total, 2, '.', '') + $subto;?>
