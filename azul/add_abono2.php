...
<table cellspacing="5" cellpadding="0" align="center" class="rg-container">
  <col width="215" />
  <col width="101" />
  <tr>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center" class="rg-container">
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">&nbsp;</td>
      <td><input type="hidden" name="venta_has_articulos_venta_idventa" value="<?php echo $venta;
	  //onclick="ticket()"?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">&nbsp;</td>
      <td><input type="submit" class="button"   value="Agregar Abono "/></td>
    </tr>
  </table>
...
<div align="center">
  <input name="historial" type="button" class="button" id="historial" onClick="
  
  if(document.getElementById('historial').style.display == 'block')
  {document.getElementById('historial').style.display = 'none';}
  else
  {document.getElementById('historial').style.display = 'block';}" value="Ver Historial"/>
</div>
</body>
</html>
<?php
