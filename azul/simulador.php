...
<body>
<form action="simulador.php" method="get">
<table  border="1" rules="all" align="center">
  ...
  <tr>
    ...
    <td><label for="tasa"></label>
      <input type="text" name="tasa" id="tasa" value = "2.5"/>
      %</td>
  </tr>
  <tr>
    <td>Fecha</td>
...
<table border="1" align="center" rules="all">
  ...
  <tr>
    ...
    <td height="22"><?php $fecha = strtotime ( '+7 day' , strtotime ( $fecha ) ) ;
    ...
    <td>$<?php echo number_format($interes = $_GET['cantidad'] * $tas, 2, '.', '');?></td>
    <td>$<?php echo number_format($capital + $interes, 2, '.', '');?></td>
  <?php } ?>
  </tr>
</table>
