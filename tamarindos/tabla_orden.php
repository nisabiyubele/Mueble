...
$pp = $pt+$res;echo "$ ". number_format($pp, 2, '.', '');?></td>
      ...
      <td><a href="imagen.php?idproducto=<?php echo $row_Recordset1['idproducto']; ?>&amp;precio=<?php echo $pp; ?>" target="_blank"><img  src="<?php echo $row_Recordset1['imagen']; ?>" alt="Imagen" name="opener" width="50" height="50" id="opener"  /></a></td>
    </tr>
