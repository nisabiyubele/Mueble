...
$query_Recordset1 = "SELECT * FROM cliente WHERE nombre = '".$_GET['nombre']."'";
...
<script>
function agre(){
window.opener.document.getElementById('nombre').value = document.getElementById('nombre').value;
window.opener.document.getElementById('direccion').value = document.getElementById('dir').value;
/*
...
<form action="" method="get">
  ...
  <input name="id" type="hidden" id="id"  value="<?php echo $row_Recordset1['idclientes']; ?>" readonly="readonly"/>
