...
mysql_select_db($database_conexion, $conexion);
$query_Recordset2 = "SELECT * FROM venta_has_articulos, clientes,articulos WHERE idclientes = clientes_idclientes AND idarticulos = articulos_idarticulos AND venta_ideventa LIKE  '%".$cliente."%'";
...
<form method="post" name="form1" id="form1">
    ...
    <?php do { ?>
     <tr>
        <td><?php echo $row_Recordset2['cancelada']; ?></td>
        ...
        <td><input type="button" name="abono" id="abono" value="Abonar" onclick="abon(<?php echo "'".$row_Recordset2['venta_ideventa']."'"; ?>)"/></td>
     </tr>
