  ...
  <td width="800" height="901" align="center"  valign="top"><p>&nbsp;</p>
   <table width="600" border="1" align="center" cellpadding="0" cellspacing="0"  rules="groups" class="letras">
    ...
    <tr>
      ...
      <td align="center"><?php echo $row_Recordset2['comision']."%"; ?></td>
      <td align="right"><strong>Ventas</strong></td>
      <td><?php echo $row_Recordset2['ventas']; ?></td>
      <td align="right"><strong>Enganches<br />
      </strong></td>
      <td><?php echo $row_Recordset2['enganches']; ?></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="2" class="intper">&nbsp;</td>
      <td class="intper">&nbsp;</td>
      <td class="intd">Muebles</td>
      <td class="intd"><?php echo $row_Recordset2['muebles'];?></td>
      <td class="intd"><?php echo $row_Recordset2['sal_mueb'];?></td>
    </tr>
    <tr>
      <td colspan="2" class="intper">&nbsp;</td>
      <td class="intper">&nbsp;</td>
      <td class="intd">Fugas</td>
      <td class="intd"><?php echo $row_Recordset2['fugas'];?></td>
      <td class="intd"><?php echo $row_Recordset2['sal_fuga'];?></td>
    </tr>
    <tr>
      <td colspan="2" class="intper">&nbsp;</td>
      <td class="intper">&nbsp;</td>
      <td class="intd">Faltante</td>
      <td class="intd"><?php echo $row_Recordset2['faltantes'];?></td>
      <td class="intd"><?php echo $row_Recordset2['sal_falta'];?></td>
    </tr>
    <tr>
      <td colspan="2" class="intper">&nbsp;</td>
      <td class="intper">&nbsp;</td>
      <td class="intd">Penalización</td>
      <td class="intd">&nbsp;</td>
      <td class="intd">&nbsp;</td>
    </tr>
    <tr>
