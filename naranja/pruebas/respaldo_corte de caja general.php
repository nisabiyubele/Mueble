...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO articulos (idarticulos, articulo, modelo, existencia, cost_unitario, factura) VALUES (%s, %s, %s, %s, %s, %s)",
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  ...
  $insertGoTo = "respaldo_corte de caja general.php";
  if (isset($_SERVER['QUERY_STRING'])) {
    $insertGoTo .= (strpos($insertGoTo, '?')) ? "&" : "?";
    $insertGoTo .= $_SERVER['QUERY_STRING'];
  }
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO cortecaja (fecha_corte, trabajadores_idtrabajadores, concepto, cantidad,entrada) VALUES (%s, %s, %s, %s,0)",
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO cortecaja (fecha_corte, trabajadores_idtrabajadores, concepto, cantidad, entrada) VALUES (%s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['fecha_corte'], "date"),
                       GetSQLValueString($_POST['trabajadores_idtrabajadores'], "int"),
                       GetSQLValueString($_POST['concepto'], "text"),
                       GetSQLValueString($_POST['cantidad'], "double"),
...
mysql_select_db($database_conexion, $conexion);
$query_Recordset1 = "SELECT * FROM cortecaja WHERE fecha_corte BETWEEN '".$fec1." 00:00:00' AND '".$fec1." :23:59:59' AND entrada = '1' GROUP BY fecha_corte";
...
mysql_select_db($database_conexion, $conexion);
$query_Recordset4 = "SELECT * FROM cortecaja WHERE fecha_corte  BETWEEN '".$fec1." 00:00:00' AND '".$fec1." :23:59:59' AND entrada = '0' GROUP BY fecha_corte";
...
?>
  ...
  <table >
    <tr valign="baseline">
      ...
      <td><input type="text" name="fecha_corte" value="<?php  echo $fec;   ?>" size="32" readonly /></td>
    </tr>
    <tr valign="baseline">
