...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO cortecaja (fecha_corte, concepto, cantidad,entrada,comprobante,descripcion) VALUES (%s, %s, %s,%s,%s,%s)",
...
<form action="corte_sucursal.php" method="post">
...
<table rules="all" border="1" class="letras">
  <tr align="center">
    <td colspan="2"><img src="logo-correcto.jpg" width="73" height="60" /><span class="enca" align ="center">Corte de Caja del <?php echo "$dia, $dia2 de $mes de $ano"; ?> </span></td>
  </tr>
  <tr>
