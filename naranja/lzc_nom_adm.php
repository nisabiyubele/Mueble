...
<title>Nómina Administrativos</title>
<style type="text/css">
.den{
    clear: both;
    width: 100%;
...
?>
    ...
    <?php echo "Del ".$fechas[2]." de ".$meses[$fechas[1]-1]." de ".$fechas[0]." al ".($fechas2[2])." de ".$meses[$fechas2[1]-1]." de ".$fechas2[0];?></p>
    <p class="enca"><?php echo " Administrativos (".$sucursal.")" ?> </p>
<form  method="post" action="lzc_nom_adm.php" align = "center">
  <p>
