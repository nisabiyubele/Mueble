...
"ticket.php?fecha="+fecha+"&cantidad="+ atot+"&saldo="+saldo+"&cliente=<?php echo $row_Recordset2['articulo'];?>&articulo=<?php echo $art;?>&idabono=<?php echo $row_Recordset2['idabonos'];?>&fv=<?php echo $row_Recordset2['hoy'];?>&multa="+multa
...
"ticket.php?fecha=<?php echo $row_Recordset2['fechab']?>&cantidad=<?php echo $row_Recordset2['acantidad']?>&saldo=<?php echo $row_Recordset2['saldo']?>&cliente=<?php echo $row_Recordset2['nombre'];?>&articulo=<?php echo $row_Recordset2['articulo'];?>&idabono=<?php echo $row_Recordset2['idabonos'];?>&fv=<?php echo $row_Recordset2['hoy'];?>"
...
<table border="1" id="historial" style="display:none;">
  <tr>
    <td>&nbsp;</td>
    <td>Fecha</td>
    <td>Cantidad</td>
  ...
  do { ?>
    <tr>
      <td><a href="ticket.php?fecha=<?php echo $row_Recordset2['fechab'];?>&cantidad=<?php echo $row_Recordset2['acantidad'];?>&saldo=<?php echo $row_Recordset2['saldo'];?>&cliente=<?php echo $row_Recordset2['nombre'];?>&articulo=<?php echo $row_Recordset2['articulo'];?>&idabono=<?php echo $row_Recordset2['idabonos'];?>&fv=<?php echo $row_Recordset2['hoy'];?>">Reimprimir</a></td>
    ...
    <?php 
	 ...
	 $fv = strtotime ( '+7 day' , strtotime ($row_Recordset2['hoy'] ) ) ;
	$fv = date ( 'Y-m-d' , $fv ); 
...
/*
	...
	if($periodo >= 15){
		...
		echo " y lleva ".$atraso."días atrasado en su pago.";
	}
...
<table cellspacing="5" cellpadding="0" align="center">
  ...
  <tr>
	...
	echo $datetime1->format('Y-m-d')." hace ".$diferencia_dias." dias";
  ...
  <tr>
    ...
    <td><input type="text" value="<?php echo $fec_ve;?>"/></td>
  </tr>
  <tr>
    <td align="right">Pagos realizados: </td>
    <td><input type="text" value="<?php echo $totalRows_Recordset2;?>"/></td>
  </tr>
  <tr>
    <td align="right">Semanas Transcurridas:</td>
    <td><input type="text" value="<?php echo round($dif_vn/7,0, PHP_ROUND_HALF_DOWN);$vencido = round($dif_vn/7,0, PHP_ROUND_HALF_DOWN) - $totalRows_Recordset2?>"/></td>
  </tr>
</table>
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><input name="ante" type="text" id="ante2" value="<?php echo $saldo;?>" size="32" readonly /></td>
    </tr>
    <tr valign="baseline">
	...
	if($rest == "AT"){ 
	  if($totalRows_Recordset2 < ($semanas) ){
	  	$multa = 30;
    ...
    <tr valign="baseline">
      ...
      <input type="text" name="saldo" id="saldo" value="<?php echo $saldo-($row_Recordset3['abonos']-$multa);?>" />
      </td>
    </tr>
    <tr>
      <td align="right">Salda Con : </td>
      <td><input type="text" value="<?php echo $saldo*0.8;?>"/></td>
    </tr>
    <tr valign="baseline">
