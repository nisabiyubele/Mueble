...
$query_Recordset1 = sprintf("SELECT * FROM trabajadores WHERE tipo = 'Ventas' AND sucursal ='Apatzingan'");
...
mysql_select_db($database_conexion, $conexion);
$query_Recordset2 = sprintf("SELECT * FROM nomina_vent, trabajadores WHERE idtrabajadores = trabajadores_idtrabajadores AND sucursal ='Apatzingan'");
...
?><table  height="694" cellspacing="5"  >
  ...
  <td width="800" height="634" align="center"  valign="top"><p>&nbsp;</p>
   <table width="500" border="1" align="center" cellpadding="0" cellspacing="0"  rules="groups" class="letras">
    <col width="126" />
    <col width="56" />
    <col width="130" />
    <col width="86" />
    ...
    <tr>
      <td class="letras" colspan="3"><strong>N° de Ventas: <?php echo $row_Recordset2['n_ventas'];?></strong></td>
      <td  class="letras" colspan="3"><strong>Total Ventas:$<?php echo $row_Recordset2['ventas'];?></strong></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="2" class="intper">&nbsp;</td>
      <td class="intper">&nbsp;</td>
      <td colspan="2" class="intd"><strong>Faltantes</strong></td>
      <td class="intd"><?php echo $row_Recordset2['faltantes'];?></td>
    </tr>
    <tr>
      <td colspan="2" class="intper">&nbsp;</td>
      <td class="intper">&nbsp;</td>
      <td colspan="2" class="intd"><strong>Fugas</strong></td>
      <td class="intd"><?php echo $row_Recordset2['fugas'];?></td>
    </tr>
    <tr>
      <td colspan="2" class="intper">&nbsp;</td>
      <td class="intper">&nbsp;</td>
      <td colspan="2" class="intd"><strong>Muebles</strong></td>
      <td class="intd"><?php echo $row_Recordset2['muebles'];?></td>
    </tr>
    <tr>
      <td colspan="2" class="intper">&nbsp;</td>
      <td class="intper">&nbsp;</td>
      <td colspan="2" class="intd"><strong>Devoluciones</strong></td>
      <td class="intd"><?php echo $row_Recordset2['devoluciones'];?></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="3" align="center" valign="bottom" bordercolor="#000000" bordercolordark="#333333" rules="all">  _______________________________</td>
      <td colspan="3">
        <?php 
//$num = 1990;
 $V=new EnLetras();
