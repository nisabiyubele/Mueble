...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO trabajadores (nombre, fecha_ingreso, fecha_termino, nss, puesto, depto, tipo, rfc, curp, sucursal, tipo_contrato) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "index.php?option=com_content&view=article&id=7";
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  ...
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><input name="fecha_ingreso" type="text" id="fecha_ingreso" value="" size="32" /></td>

    </tr>

    <tr valign="baseline">

      <td nowrap="nowrap" align="right">Fecha de termino(Determinado):</td>

      <td><input name="fecha_termino" type="text" id="fecha_termino" value="" size="32" /></td>
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="nss" value="" size="32" /></td>
