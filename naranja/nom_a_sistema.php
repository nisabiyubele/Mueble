...
switch($sucursal){
case "Apatzingan":
$direccion ="Prol. Francisco Argandar N°8 Col.Nueva C.P. 60678.";
$ciudad = "Tel.(453)534 54 43 Apatzingan, Michoacan";
break;

case "Uruapan":
$direccion ="Ignacio Allende N°314 Col.Lazaro Cardenas C.P. 60050 ";
$ciudad = "Tel. (452)528-46-99 Uruapan Michoacan";
break;


case "Tacambaro":
$direccion ="Carretera Morelia-Tacambaro Km 1.5 S/N Col. El Testarazo C.P. ";
$ciudad = "Tel. (459)569-18-85 Tacambaro, Michoacan";
break;


case "Lazaro Cardenas":
$direccion ="Av Melchor Ocampo S/N Esq. Libramiento Col. Emiliano Zapata C.P.60950";
$ciudad = "Tel.(753)5372044 Lazaro Cardenas, Michoacan";
break;

case "Ciudad Hidalgo":
$direccion ="vicente Guerrero N°293 Col.San Francisco Ojos de Agua C.P.";
$ciudad = "Tel. (786)154-08-65 Cd. Hidalgo, Michoacan";
break;
}
...
$query_Recordset1 = sprintf("SELECT * FROM trabajadores WHERE tipo = 'Administracion' AND sucursal ='".$sucursal."'");
...
mysql_select_db($database_conexion, $conexion);
$query_Recordset2 = sprintf("SELECT * FROM nomina, trabajadores WHERE idtrabajadores = trabajadores_idtrabajadores AND sucursal ='".$sucursal."' AND fecha_na BETWEEN '".$f."' AND '".$f1."'");
...
?><table  height="913" cellspacing="5"  >
  ...
  <td width="800" height="901" align="center"  valign="top"><p>&nbsp;</p>
   <table width="600" border="1" align="center" cellpadding="0" cellspacing="0"  rules="groups" class="letras">
    ...
    <tr class="memb">
      <td colspan="4"><?php echo $ciudad;?></td>
    </tr>
    <tr class="memb">
    ...
    <tr>
	  ...
	  echo "$ ". number_format($row_Recordset2['seguro'], 2, '.', '');
	  
	   $seguro =$row_Recordset2['seguro']; ?></td>
    </tr>
    <tr>
      ...
      <td class="intd">&nbsp;</td>
      <td class="intd"><?php 
	  echo "$ ". number_format($row_Recordset2['vales'], 2, '.', '');
	  
	  ; $vales = $row_Recordset2['vales'];?></td>
    </tr>
    <tr>
      <td colspan="2" class="intper"><strong>Incentivos</strong></td>
      <td class="intper">&nbsp;</td>
      <td class="intd"><strong>Prestamos</strong></td>
      <td class="intd"><?php  echo "$ ". number_format($row_Recordset2['prestamo'], 2, '.', '');
	  ?></td>
      <td class="intd"><?php echo "$ ". number_format($row_Recordset2['des_pres'], 2, '.', '');?></td>
    </tr>
    <tr>
      <td colspan="2" class="intper">&nbsp;</td>
      <td class="intper">&nbsp;</td>
      <td class="intd"><strong>Motocicleta</strong></td>
      <td class="intd"><?php echo "$ ". number_format($row_Recordset2['moto'], 2, '.', '');?></td>
      <td class="intd"><?php echo "$ ". number_format($row_Recordset2['desc_moto'], 2, '.', '');?></td>
    </tr>
    <tr>
      <td colspan="2" class="intper">&nbsp;</td>
      <td class="intper">&nbsp;</td>
      <td class="intd"><strong><?php echo $row_Recordset2['ot_conc'];?></strong></td>
      <td class="intd"><?php echo "$ ". number_format($row_Recordset2['adeudo'], 2, '.', '');?></td>
      <td class="intd"><?php echo "$ ". number_format($row_Recordset2['ot_impo'], 2, '.', '');?></td>
    </tr>
    <tr>
      <td colspan="2" class="intper">&nbsp;</td>
      <td class="intper">&nbsp;</td>
    ...
    <tr>
      ...
      <td align="right" class="intd"><?php echo "$ ". number_format($row_Recordset2['total_egr'], 2, '.', '');
	 ?></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    ...
    <tr>
      ...
      <td align="center"><strong><?php echo "$ ". number_format($row_Recordset2['total'], 2, '.', '');?></strong></td>
    </tr>
    <tr>
