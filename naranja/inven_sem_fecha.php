...
<p class="enca">        
<form id="form1" name="form1" method="post" action="inven_sem_fecha.php">
  <label for="fech_ini"></label>
  Del(aaaa/mm/dd)
  <input type="text" name="fech_ini" id="fech_ini" />
Al(aaaa/mm/dd) 
<label for="fech_fin"></label>
  <input type="text" name="fech_fin" id="fech_fin" />
  <input type="submit" name="filtra" id="filtra" value="Enviar" />
</form>
<p class="enca">        
<table rules="all" border="1" align="center" id="simple" class="sortable">
  <tr align="center">
    ...
    <td class="exis"><strong>Existencia Ini</strong></td>
    <td class="exis"><strong>Ultimo Inv</strong></td>
