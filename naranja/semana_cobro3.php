...
$query_Recordset1 = "SELECT * FROM trabajadores,vale WHERE trabajadores_idtrabajadores = idtrabajadores AND fecha  BETWEEN '".$f."' AND '".$f1."' AND sucursal = '".$sucursal."' GROUP BY nombre";
...
<body>
<form action="semana_cobro3.php" method="post" align= "center">
  <p>
...
<h1 align="center"> Resumen Semanal de la Sucursal por Cobrador: <?php echo $sucursal." (".$f."/".$f1.")"; ?></h1>
