...
mysql_select_db($database_conexion, $conexion);
$query_Recordset3 = "SELECT * FROM abonos WHERE
     venta_has_articulos_clientes_idclientes='".$cliente."' 
...
$semanas = round($dif_vn/7,0, PHP_ROUND_HALF_DOWN);
...
//************************************************?>
>
        <td><?php echo $row_Recordset2['cancelada'];	
